# Game Boy Advance assets

These files are owned by the Game Boy Advance console plugin. They are declared by the plugin and
resolved by the host through the console asset contract.
...
The GBA presentation is wide and uses the native `240x160` video profile. No ROMs or commercial
