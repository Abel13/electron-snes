...
const en = {
  translation: {
    ...
    emptyBody: 'Add your own .gb, .gbc or .gba files. Your library stays private on this computer.',
    ...
    autosaveFound: 'Autosave found',
    autosaveUpdated: 'Saved {{date}}',
    continueAutosave: 'Continue autosave',
    ...
    updateAvailable: 'Download {{version}}',
...
const pt = {
  translation: {
    ...
    emptyBody:
      'Adicione seus arquivos .gb, .gbc ou .gba. Sua biblioteca permanece privada neste computador.',
    ...
    autosaveFound: 'Autosave encontrado',
    autosaveUpdated: 'Salvo em {{date}}',
    continueAutosave: 'Continuar autosave',
    startNormally: 'Iniciar normalmente',
    ...
    updateAvailable: 'Baixar {{version}}',
    updateDownloading: 'Baixando {{percent}}%',
...
const zh = {
  translation: {
    ...
    emptyBody: '添加您自己的 .gb、.gbc 或 .gba 文件。游戏库仅保存在此电脑上。',
    ...
    autosaveFound: '发现自动存档',
    autosaveUpdated: '保存于 {{date}}',
    continueAutosave: '继续自动存档',
    startNormally: '正常开始',
    exitQuestion: '退出这个游戏？',
