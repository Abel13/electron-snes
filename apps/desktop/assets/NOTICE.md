...
Runtime assets are grouped by visual class so contributors can find and review each export without
opening the renderer. The Game Boy Advance entries below cover the four declared asset classes from
the [asset guide](../../../docs/design/assets.md).

| Asset                                             | Author                 | Source                       | License | Date       |
| ------------------------------------------------- | ---------------------- | ---------------------------- | ------- | ---------- |
| `consoles/game-boy-advance-console-hero.png`      | PixelCore contributors | Original generated artwork   | CC0-1.0 | 2026-08-14 |
...
for the supported window sizes.
